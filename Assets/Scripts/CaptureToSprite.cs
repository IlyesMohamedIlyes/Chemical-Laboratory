...
public class CaptureToSprite : MonoBehaviour
{
    ...
    private static CaptureToSprite _instance;
    public static CaptureToSprite Instance
    {
        get
        {
            return _instance;
...
//        captureScreenshot |= Input.GetKeyDown("k");
        ...
        if (captureScreenshot || captureVideo)
        {
            ...
            // reset active  texture and render texture
